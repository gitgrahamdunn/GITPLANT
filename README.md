...
This repository now contains the **Week 1+2 project foundation** for an oil & gas EDMS MVP.

## What is included
- FastAPI backend scaffold
- PostgreSQL local dependency via Docker Compose
- Starter domain entities (`User`, `Document`, `Branch`, `DocumentRevision`)
- Starter auth endpoint with role-based demo users
- Week 2 versioning endpoints for document commit/push/pull/history
- Basic tests for health, auth, and versioning flow
...
## Planned next steps (Week 3+)
- Revision comparison endpoint (metadata + file diff integration)
