...
This repository now contains the **Week 1–3 project foundation** for an oil & gas EDMS MVP.
...
- Basic tests for health, auth, versioning flow, and revision comparison
